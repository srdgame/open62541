...
public:
	...
	*/
	...
	std::tuple getState(sol::this_state L) {
	...
	*/
	...
	std::tuple getNamespaceIndex(const char* namespaceUri, sol::this_state L) {
	...
	std::tuple getNode1(const UA_NodeId& id, sol::this_state L) {
		UA_NodeId outId;
	...
	std::tuple getNode2(int ns, int id, sol::this_state L) {
		return getNode(UA_NODEID_NUMERIC(ns, id), L);
	}
	std::tuple getNode3(int ns, const char* id, sol::this_state L) {
		return getNode(UA_NODEID_STRING(ns, (char*)id), L);
	}
	std::tuple getNode4(int ns, const UA_Guid& id, sol::this_state L) {
		return getNode(UA_NODEID_GUID(ns, id), L);
	}

	UA_StatusCode deleteNode1(const UA_NodeId& nodeId, bool deleteReferences) {
		return _mgr->deleteNode(nodeId, deleteReferences);
	}
	UA_StatusCode deleteNode2(const UA_Node& node, bool deleteReferences) {
		return deleteNode(node._id, deleteReferences);
	}

	std::tuple createSubscription(SubscribeCallback callback, sol::this_state L) {
		UA_StatusCode re = -1;
		if (!this->_client) {
	...
	std::tuple subscribeNode(UA_UInt32 sub_id, const UA_NodeId& nodeId, sol::this_state L) {
		/* Add a MonitoredItem */
	...
	std::tuple callMethod(const UA_NodeId& objectId, const UA_NodeId& methodId, sol::variadic_args args, sol::this_state L) {
...
void reg_opcua_client(kaguya::State& L) {
	L["ConnectionConfig"].setClass(kaguya::UserdataMetatable<UA_ConnectionConfig>()
			.addProperty("protocolVersion", &UA_ConnectionConfig::protocolVersion)
			.addProperty("sendBufferSize", &UA_ConnectionConfig::sendBufferSize)
			.addProperty("recvBufferSize", &UA_ConnectionConfig::recvBufferSize)
			.addProperty("localMaxMessageSize", &UA_ConnectionConfig::localMaxMessageSize)
			.addProperty("remoteMaxMessageSize", &UA_ConnectionConfig::remoteMaxMessageSize)
			.addProperty("localMaxChunkCount", &UA_ConnectionConfig::localMaxChunkCount)
			.addProperty("remoteMaxChunkCount", &UA_ConnectionConfig::remoteMaxChunkCount)
	);
	L["ClientConfig"].setClass(kaguya::UserdataMetatable<UA_ClientConfig_Proxy>()
			.addFunction("setTimeout", &UA_ClientConfig_Proxy::setTimeout)
			.addFunction("setSecureChannelLifeTime", &UA_ClientConfig_Proxy::setSecureChannelLifeTime)
			.addFunction("setProductURI", &UA_ClientConfig_Proxy::setProductURI)
			.addFunction("setApplicationURI", &UA_ClientConfig_Proxy::setApplicationURI)
			.addFunction("setApplicationName", &UA_ClientConfig_Proxy::setApplicationName)
	);

	L["UA_ClientConfig"].setClass(kaguya::UserdataMetatable<UA_ClientConfig>()
		.addProperty("timeout", &UA_ClientConfig::timeout)
		.addProperty("clientDescription", &UA_ClientConfig::clientDescription)
		.addProperty("secureChannelLifeTime", &UA_ClientConfig::secureChannelLifeTime)
		.addProperty("requestedSessionTimeout", &UA_ClientConfig::requestedSessionTimeout)
		.addProperty("localConnectionConfig", &UA_ClientConfig::localConnectionConfig)
		.addProperty("connectivityCheckInterval", &UA_ClientConfig::connectivityCheckInterval)
	);

	L["Client"].setClass(kaguya::UserdataMetatable<UA_Client_Proxy>()
			.setConstructors<UA_Client_Proxy(), UA_Client_Proxy(UA_MessageSecurityMode, const std::string&, const std::string&)>()
			.addProperty("config", &UA_Client_Proxy::_config)
			.addFunction("setStateCallback", &UA_Client_Proxy::setStateCallback)
			.addFunction("getState", &UA_Client_Proxy::getState)
			//"reset", &UA_Client_Proxy::reset,
			.addFunction("connect", &UA_Client_Proxy::connect)
			.addFunction("connect_username", &UA_Client_Proxy::connect_username)
			.addFunction("connectUsername", &UA_Client_Proxy::connectUsername)
			.addFunction("disconnect", &UA_Client_Proxy::disconnect)
			.addFunction("getEndpoints", &UA_Client_Proxy::getEndpoints)
			.addFunction("findServers", &UA_Client_Proxy::findServers)
			.addFunction("getNamespaceIndex", &UA_Client_Proxy::getNamespaceIndex)
			.addFunction("getNodeMgr", &UA_Client_Proxy::getNodeMgr)
			.addFunction("getObjectsNode", &UA_Client_Proxy::getObjectsNode)
			.addFunction("getTypesNode", &UA_Client_Proxy::getTypesNode)
			.addFunction("getViewsNode", &UA_Client_Proxy::getViewsNode)
			.addFunction("getServerNode", &UA_Client_Proxy::getServerNode)
			.addFunction("getRootNode", &UA_Client_Proxy::getRootNode)
			.addOverloadedFunctions("getNode",
				&UA_Client_Proxy::getNode1, 
				&UA_Client_Proxy::getNode2,
				&UA_Client_Proxy::getNode3,
				&UA_Client_Proxy::getNode4)
			.addOverloadedFunctions("deleteNode",
					&UA_Client_Proxy::deleteNode1,
					&UA_Client_Proxy::deleteNode2)
			.addFunction("createSubscription", &UA_Client_Proxy::createSubscription)
			.addFunction("subscribeNode", &UA_Client_Proxy::subscribeNode)
			.addFunction("callMethod", &UA_Client_Proxy::callMethod)
			.addFunction("run_iterate", &UA_Client_Proxy::run_iterate)
	);

	module.new_usertype<ClientNodeMgr>("ClientNodeMgr",
		.addFunction("addReference", &ClientNodeMgr::addReference)
		.addFunction("deleteReference", &ClientNodeMgr::deleteReference)
		.addFunction("deleteNode", &ClientNodeMgr::deleteNode)
		.addFunction("addObject", &ClientNodeMgr::addObject)
		.addFunction("addObjectType", &ClientNodeMgr::addObjectType)
		.addFunction("addVariable", &ClientNodeMgr::addVariable)
		.addFunction("addVariableType", &ClientNodeMgr::addVariableType)
		.addFunction("addReferenceType", &ClientNodeMgr::addReferenceType)
		.addFunction("addDataType", &ClientNodeMgr::addDataType)
		//.addFunction("addMethod", &ClientNodeMgr::addMethod
	);
